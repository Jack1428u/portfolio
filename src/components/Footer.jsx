function Footer() {
    ...
    const socialLinks = [
        {
            name: 'GitHub',
            url: 'https://github.com/jack1428u',
            icon: (
        ...
        {
            name: 'LinkedIn',
            url: 'https://www.linkedin.com/in/jack-gonzalo-utrilla-fernández-6991b4367',
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Email',
            url: 'utrillajack.consulting@gmail.com',
            icon: (
                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mb-6 max-w-md">
                            Estudiante de Ingeniería de Sistemas especializado en arquitectura de software,
                            desarrollo Full Stack y DevOps. Siempre abierto a nuevas oportunidades y
                            colaboraciones.
                        </p>
                        <div className="flex gap-4">
                            {socialLinks.map((link) => (
                                <a
                                    key={link.name}
                                    href={getValidHref(link.url)}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-gray-400 hover:text-accent-primary transition-smooth"
